...
# echo "$LOGMARK decode mono"
# (
# utils/mkgraph.sh data/graph/lang exp/mono_ali exp/mono_ali/graph
# steps/decode.sh --nj $n --cmd "$train_cmd" --skip_scoring true\
#   exp/mono_ali/graph data/dev exp/mono_ali/decode_dev
# )
...
# echo "$LOGMARK decode tri1_ali"
# (
# utils/mkgraph.sh data/graph/lang exp/tri1_ali exp/tri1_ali/graph
# steps/decode.sh --nj $n --cmd "$train_cmd" \
#   exp/tri1_ali/graph data/dev exp/tri1_ali/decode_dev
# )
...
# echo "$LOGMARK decode tri2b"
# (
# utils/mkgraph.sh data/graph/lang exp/tri2b exp/tri2b/graph
# steps/decode.sh --nj $n --cmd "$train_cmd" \
...
# echo "$LOGMARK decode tri2b"
# (
# utils/mkgraph.sh data/graph/lang exp/tri2b_ali exp/tri2b_ali/graph
# steps/decode.sh --nj $n --cmd "$train_cmd" \
#   exp/tri2b_ali/graph data/dev exp/tri2b_ali/decode_dev
# )
...
#
# echo "$LOGMARK decode tri3b"
# (
# utils/mkgraph.sh data/graph/lang exp/tri3b exp/tri3b/graph
# steps/decode_fmllr.sh --nj $n --cmd "$decode_cmd" \
...
# echo "$LOGMARK decode tri3b"
# (
# utils/mkgraph.sh data/graph/lang exp/tri3b_ali exp/tri3b_ali/graph
# steps/decode_fmllr.sh --nj $n --cmd "$decode_cmd" \
#    exp/tri3b_ali/graph data/dev exp/tri3b_ali/decode_dev
# )
